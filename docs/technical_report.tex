...
\begin{itemize}[leftmargin=1.5em]
  \item \textbf{Race Predictor} uses the Daniels VO2-velocity quadratic formula ($\text{VO2} = -4.60 + 0.182258v + 0.000104v^2$) with calibrated sustainability factors derived from real-world performance data.
